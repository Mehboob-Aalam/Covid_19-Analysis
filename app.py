...
app.layout = html.Div([
    ...
    html.H1("Covid-19 Impact Analysis", style={'color': '#fff', 'text-align': 'center', 'margin-top': '20px'}),
    html.Div([
        html.Div([
            html.Div([
                html.Div([
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Div([
                    dcc.Dropdown(id='plot-graph', options=options1, value='All', style={'color' : "black"}),
                    dcc.Graph(id='graph')
                ], className='card-body')
            ], className='card bg-info')
        ], className='col-md-6'),
        ...
        html.Div([
            html.Div([
                html.Div([
                    dcc.Dropdown(id='my_dropdown', options=options2, value='Status', style={"width": "100%", 'color' : "black"}),
    ...
    html.Div([
        html.Div([
            html.Div([
                html.Div([
                    dcc.Dropdown(id='picker', options=options, value='All', style={'color' : "black"}),
                    dcc.Graph(id='bar')
                ], className='card-body')
            ], className='card bg-warning')
        ], className='col-md-12')
